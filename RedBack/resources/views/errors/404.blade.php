...
<head>
    ...
    <title>404 - Página no encontrada | Redvel </title>
...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-1/4 left-1/4 w-2 h-2 bg-red-500 rounded-full opacity-20 float-animation"
            style="animation-delay: 0s;"></div>
        <div class="absolute top-1/3 right-1/4 w-1 h-1 bg-red-400 rounded-full opacity-30 float-animation"
            style="animation-delay: 2s;"></div>
        <div class="absolute bottom-1/4 left-1/3 w-3 h-3 bg-red-600 rounded-full opacity-15 float-animation"
            style="animation-delay: 4s;"></div>
        <div class="absolute top-1/2 right-1/3 w-1 h-1 bg-red-500 rounded-full opacity-25 float-animation"
            style="animation-delay: 1s;"></div>
        <div class="absolute bottom-1/3 right-1/4 w-2 h-2 bg-red-400 rounded-full opacity-20 float-animation"
    ...
    <div class="max-w-4xl w-full mx-auto text-center relative">
        ...
        <div class="slide-in" style="animation-delay: 0.4s;">
            <h1 class="error-number text-8xl md:text-9xl font-black mb-6 float-animation">
                404
            </h1>
        </div>
        ...
        <div class="slide-in" style="animation-delay: 0.6s;">
            ...
            <p class="text-gray-300 text-lg md:text-xl mb-8 max-w-2xl mx-auto leading-relaxed">
                ...
                Parece que te has perdido en <span class="titulo">Redvel</span>.
            </p>
        </div>
        ...
        <div class="slide-in flex flex-col sm:flex-row gap-4 justify-center items-center"
            ...
            <button onclick="goHome()"
                class="hover-lift bg-gradient-to-r from-red-600 to-red-700 text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-lg pulse-glow flex items-center gap-3 min-w-fit">
        ...
        <div class="slide-in mt-12 p-6 bg-gray-800 bg-opacity-50 rounded-lg border border-gray-700 backdrop-blur-sm"
            style="animation-delay: 1s;">
            <h3 class="text-red-400 font-semibold text-lg mb-3">¿Necesitas ayuda?</h3>
            <p class="text-gray-300 text-sm leading-relaxed">
                Si crees que esto es un error, por favor contacta al administrador del sistema
                o revisa la documentación del <span class="text-red-400">RedVel Framework</span>.
            </p>
        </div>

        <!-- Footer con detalles técnicos -->
        <div class="slide-in mt-8 text-gray-500 text-sm" style="animation-delay: 1.2s;">
            <p>Error Code: RV404 | RedVel Framework v1.0</p>
        </div>
    </div>
    ...
    <script>
        ...
        // Efecto de hover en las partículas
        document.addEventListener('mousemove', (e) => {
            const particles = document.querySelectorAll('.float-animation');
